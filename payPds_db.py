...
class payPdsDB:
    ...
    def createPaypdTable(self):
        self.cursor.execute("CREATE TABLE IF NOT EXISTS payPds (id SERIAL PRIMARY KEY, date VARCHAR(255), totalSavings INTEGER, diff INTEGER, diffGoal INTEGER, accounts VARCHAR(255))")
